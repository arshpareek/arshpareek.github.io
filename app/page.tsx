...
export default function Home() {
  ...
  return (
    <div className="bg-blue-50 font-frutiger grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20">
      <Wave fill='lightblue'
          paused={false}
          style={{ display: 'flex',
            position: 'fixed',
      ...
      <motion.div 
        className="
        flex rounded-fulljustify-around items-center font-bold absolute left-10 bottom-10 transition text-blue-800 bg-gray-400/20 rounded-full bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border border-gray-100
        "
      ...
      >
        <motion.button
          className='flex-col rounded-full pl-1 pt-0.5 w-10 h-10 text-blue-800 '
          whileHover={{scale: 1.1,
                      transition: { duration: 0.5 },
          }}
          whileTap={{scale: 0.9,
        ...
        <motion.button
          className='flex-col rounded-full pl--1 pt--2.9 w-11 h-11 text-blue-800 '
          whileHover={{scale: 1.1,
                      transition: { duration: 0.5 },
          }}
          whileTap={{scale: 0.9,
      ...
      <motion.button
          className='flex-col rounded-full w-10 h-10 text-blue-800  bg-gray-400/20 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border border-gray-100'
          whileHover={{scale: 1.1,
                      transition: { duration: 0.5 },
          }}
          whileTap={{scale: 0.9,
