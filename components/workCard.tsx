...
export default function WorkCard({company, date, location, logoURL, description}: Props) {
    ...
    return (
        <div className="block w-auto p-2 m-1 border-b-1" onClick={handleDropdown}>
            <div className="flex w-auto p-2 m-1">
